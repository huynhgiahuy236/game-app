...
abstract final class AppTheme {
  ...
  static const _lightScheme = ColorScheme(
    ...
    onSurface:            Color(0xFF0F0A1E),
    onSurfaceVariant:     Color(0xFF4B5478),
    outline:              Color(0xFF6B7CAA),
    outlineVariant:       Color(0xFFCDD0E8),
    surfaceContainerLowest:  Colors.white,
    surfaceContainerLow:     Color(0xFFF0EFFA),
    surfaceContainer:        Color(0xFFE5E4F5),
    surfaceContainerHigh:    Color(0xFFD8D6EC),
    surfaceContainerHighest: Color(0xFFC8C5E0),
    inverseSurface:       Color(0xFF1A1333),
    onInverseSurface:     Color(0xFFEEECFD),
